...
class ActiveModel::Serializer
  ...
  # source://activesupport/7.0.8/lib/active_support/option_merger.rb#28
  def _links; end
...
module ActiveModel::Serializer::Adapter
  class << self
    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#49
    def _deprecated_adapter_class(*_arg0, **_arg1, &_arg2); end

    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#49
    def _deprecated_adapter_map(*_arg0, **_arg1, &_arg2); end

    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#49
    def _deprecated_adapters(*_arg0, **_arg1, &_arg2); end

    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#49
    def _deprecated_create(*_arg0, **_arg1, &_arg2); end

    # source://active_model_serializers//lib/active_model_serializers/deprecate.rb#49
    def _deprecated_lookup(*_arg0, **_arg1, &_arg2); end
