...
# source://valid_email2//lib/valid_email2/address.rb#7
module ValidEmail2
  class << self
...
class ValidEmail2::Address
  ...
  # @return [Boolean]
  #
  # source://valid_email2//lib/valid_email2/address.rb#99
  ...
  # @return [Boolean]
  #
  # source://valid_email2//lib/valid_email2/address.rb#130
  def address_contain_emoticons?(email); end

  # @return [Boolean]
  #
  # source://valid_email2//lib/valid_email2/address.rb#108
  def domain_is_in?(domain_list); end

  # source://valid_email2//lib/valid_email2/address.rb#147
  def mx_or_a_servers; end

  # @return [Boolean]
  #
  # source://valid_email2//lib/valid_email2/address.rb#118
  def mx_server_is_in?(domain_list); end

  # source://valid_email2//lib/valid_email2/address.rb#136
  def mx_servers; end

  # @return [Boolean]
  #
  # source://valid_email2//lib/valid_email2/address.rb#143
  def null_mx?; end
...
# source://valid_email2//lib/valid_email2/email_validator.rb#6
